        ...
        return (
            <div>
                <div  className="page-header">
                    <h3 className="page-title"> Text Material </h3>
                                                ...
                                                <div  index={idx} className="col-md-3 grid-margin stretch-card">
                                                    ...
                                                    <div className="card-body py-5">
                                                        ...
                                                        <div style={{textAlign:'center'}} className="ml-3">
                                                            ...
                                                            <a style={{textDecoration:'none',fontSize:'15px'}} href="/hh"  className="text-facebook font-weight-semibold mb-0">Read Now</a>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    </div>
